  ...
  useEffect(() => {
    if (profileData) {
      form.reset({
        ...
        businessPostalCode: profileData.businessPostalCode ?? '',
        businessCountry: profileData.businessCountry ?? 'Austria',
    ...
    try {
      const response = await fetch('/api/settings/profile', {
        ...
        body: JSON.stringify({
          ...
          businessCity: values.businessCity || undefined,
          businessPostalCode: values.businessPostalCode || undefined,
          businessCountry: values.businessCountry || undefined,
