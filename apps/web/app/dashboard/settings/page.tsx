            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="font-medium">
                  Dr. Sarah Müller Physiotherapie
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Business Address</p>
                <p className="font-medium">
                  Landstraße 15, 4020 Linz, Austria
                </p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Email</p>
                <p className="font-medium">
                  sarah.mueller@myoflow.at
                </p>
              </div>
              <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    placeholder="25"
                    defaultValue={profileData?.travelServiceRadius || 25}
                  />
                  <p className="text-xs text-gray-500">Maximum distance for home visits</p>
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    step="0.10"
                    placeholder="0.80"
                    defaultValue={profileData?.travelRatePerKm || 0.80}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="number"
                    placeholder="15"
                    defaultValue={profileData?.defaultTravelBuffer || 15}
                  />
                  <p className="text-xs text-gray-500">Extra time between appointments</p>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="daily-km-limit">Daily KM Limit</Label>
                  <Input
                    id="daily-km-limit"
                    type="number"
                    placeholder="100"
                    defaultValue={profileData?.maxDailyTravelKm || 100}
                  />
                  <p className="text-xs text-gray-500">Maximum daily travel distance</p>
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="font-medium">
                {profileData?.businessAddress || 'Not configured'}
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Service Radius</p>
              <p className="font-medium">
                {profileData?.travelServiceRadius || 25} km
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Travel Rate</p>
              <p className="font-medium">
                €{profileData?.travelRatePerKm || 0.80}/km
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Travel Service</p>
              <p className="font-medium">
                {profileData?.enableTravelService ? '✅ Enabled' : '❌ Disabled'}
              </p>
            </div>
          </CardContent>
        </Card>
